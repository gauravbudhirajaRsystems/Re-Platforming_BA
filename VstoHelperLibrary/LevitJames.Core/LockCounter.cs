...
namespace LevitJames.Core
{
    ...
    public struct LockCounter
    {
        ...
        /// <summary>
        ///     Only locks (increments) the counter when it is the first lock.
        /// </summary>
        /// <returns>True if this is the first lock;otherwise false</returns>
        public bool TryLock()
        {
            if (LockCount == 0)
            {
        ...
        /// <summary>
        ///     True to Locks; false to Unlock the counter
        /// </summary>
